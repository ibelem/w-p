        ...
        <div class="filters">
          ...
          <div class="fi">
            <div class="checkbox">
              ...
              <label for="checkbox-2">Productivity<span class="box"></span></label>
            </div><span class="badge sp">5</span>
          </div>
        </div>
        <div class="filters">
          ...
          <div class="fi">
            <div class="checkbox">
              ...
              <label for="checkbox-6">&gt;= 1MB<span class="box"></span></label>
            </div><span class="badge sp">12</span>
          </div>
        </div>
      </section>
    </div>
