<template>
  <div id="wrap" :class="{ 'onScroll': !isTopOfPage }">
    <header>
      <a class="logo" href="#/">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 389.48 82.98">
          <defs></defs>
          <title>Webnizer</title>
          <text class="logo-1" transform="translate(72.99 53.93)">webnizer</text>
          <path class="logo-2"
          ...
          <path class="logo-2" d="M43.54,74.27A21.73,21.73,0,1,0,74.27,43.54l-.19-.18L43.36,74.08Z"
            transform="translate(-20.52 -19.66)" />
        </svg>
      </a>
      <Nav />
